    ...
    const sampleData = [
      {
        ...
        salary: "₹8-12 LPA",
        location: "Bangalore",
        jobUrl: "https://linkedin.com/jobs/sample",
        notes: "React and TypeScript required",
      },
      {
        id: 2,
        ...
        salary: "₹10-15 LPA",
        location: "Remote",
        jobUrl: "https://naukri.com/jobs/sample",
        notes: "MERN stack position",
      },
    ];
    ...
    if (editMode) {
      setApplications(
        applications.map((app) =>
          app.id === currentApp.id ? { ...formData, id: currentApp.id } : app
        )
      );
    } else {
      const newApp = {
          ...
          <div className="header-content">
            <div className="header-left">
              ...
              <div>
                ...
                <p className="subtitle">Manage your job search efficiently</p>
              </div>
            </div>
